...
/**
 * Implementation of [IGroupDAO] for managing Group entities in a JSON-based data source.
 */
class GroupDAOJSON(private val dataSource: DataSource, private val console: IOutputInfo): IGroupDAO {
